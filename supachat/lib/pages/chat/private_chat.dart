...
import 'package:supachat/models/chat_message.dart';
import 'package:supachat/pages/chat/widget/chat_bar.dart';
import 'package:supachat/pages/chat/widget/chat_bubble.dart';
import 'package:supachat/utils/constants.dart';


class PrivateChat extends StatefulWidget {
  final String roomId;
  const PrivateChat({ super.key, required this.roomId });
